...
> **OVERRIDE:** The committed product brief is [`docs/design/games.md`](../../games.md)
> (**ARCD** / “Cabinet After Hours”). This MASTER was auto-generated by ui-ux-pro-max
> (Brutalism + pink) and is retained for Pro Max retrieval only — **do not implement
> its palette or type**. Follow `games.md` + `.vertical-games` tokens.

> **LOGIC:** When building a specific page, first check `design-system/pages/[page-name].md`.
> If that file exists, its rules **override** this Master file.
> If not, strictly follow the rules below — **except** where they conflict with `games.md`.

---

**Project:** Games
**Generated:** 2026-08-14 00:45:58

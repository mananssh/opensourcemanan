...
- **23:11 · `1706318` · feat:** site-wide navigation loading feedback (top progress bar, busy cursor, route skeletons) + Reel in the OSM manifesto
...
- **22:25 · `4959a6e` · feat:** Reel — track TV seasons & episodes with per-episode progress
  ...
  show's total.
- **22:18 · `0c78847` · feat:** Reel redesign — "VHS / Video Nasty" theme, live search dropdown polish, fixed shareable cards
...
- **16:59 · `0dc2ecb` · feat:** Reel Phase 3 — activity calendar, richer stats, ticket-stub shareables & a Wrapped recap
...
- **16:41 · `65adbfb` · feat:** Reel Phase 2 — follow friends by @handle + a friends strip on the dashboard
...
- **16:25 · `2d0a9fb` · feat:** add Reel — a multi-user movie & TV tracker vertical (Phase 1)

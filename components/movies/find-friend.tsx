...
export function FindFriend() {
  ...
  return (
    <form onSubmit={go} className="flex items-center gap-2">
      <div className="flex flex-1 items-center border border-rule bg-surface px-3 py-1.5 focus-within:border-accent">
      ...
      <button
        type="submit"
        className="inline-flex h-8 items-center border border-rule px-3 font-mono text-[0.6rem] uppercase tracking-[0.14em] text-muted transition-colors hover:border-accent hover:text-accent"
      >
        Go →
      </button>
    </form>

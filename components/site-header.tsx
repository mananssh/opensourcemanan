...
/**
 * Editorial site header. OSM is the directory — the /osm index lists the
 * verticals, so the navbar stays minimal: wordmark (→ /osm) + theme toggle +
  ...
  return (
    <header className="sticky top-0 z-40 border-b border-rule bg-paper/85 backdrop-blur-sm">
      <nav className="container-editorial flex items-center justify-between py-5">
        <Link href="/osm" className="inline-flex items-baseline gap-0.5">

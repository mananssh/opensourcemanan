        ...
        >
          ...
          {c.coverImageKey && (
            ...
            <img
              ...
              alt=""
              aria-hidden
              className="pointer-events-none absolute -bottom-3 -right-4 h-20 w-20 rotate-[25deg] rounded-md object-cover shadow-xl transition-transform duration-200 group-hover:rotate-[20deg] sm:h-24 sm:w-24"
            />
          )}
        </Link>
      ))}
